		...
		<nav class="colorlib-nav" role="navigation">
			<div class="top-menu">
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-2">
							<div id="colorlib-logo"><a href="index.html" class="logo">BeyonSky</a></div>
						</div>
						<div class="col-xs-10 text-right menu-1">
							<ul>
								<li class="active"><a class="lang" key="hm1" href="index.html" style="font-size:18px ;">Home</a></li>
								<li  class="has-dropdown">
									<a class="lang" key="hm2"  href="tours.html"style="font-size:18px ;">Services</a>
									<ul class="dropdown">
										<li><a class="lang" key="hm3"  href="#">Tours</a></li>
										<li><a class="lang" key="hm3"  href="#">Destination</a></li>
										<li><a class="lang" key="hm4" href="india.html">India</a></li>
										<li><a class="lang" key="hm5" href="international.html">International</a></li>
										<li><a class="lang" key="hm6" href="#">Cruises</a></li>
										<li><a class="lang" key="hm7" href="#">Hotels</a></li>
										</ul>
								</li>
								<li><a class="lang" key="hm10"  style="font-size:18px;" href="space.html">Freight</a></li>
								<li><a class="lang" key="hm10"href="space.html"style="font-size:18px ;">Blog</a></li>
								<li><a class="lang" key="hm13" href="about.html"style="font-size:18px ;">About</a></li>
								<li><a class="lang" key="hm14" href="contact.html"style="font-size:18px ;">Contact</a></li>
		...
		<aside id="colorlib-hero">
			<div class="flexslider">
				<ul class="slides">
			   	...
			   	<li style="background-image: url(images/mun1.jpg);">
			   		<div class="overlay"></div>
			   		<div class="container-fluid">
			   			<div class="row">
				   			<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner text-center">
				   					<h2 class="lang" key="t3">10 Days Cruises</h2>
				   					<h1 class="lang" key="t4">From Greece to Spain</h1>
				   				</div>
				   			</div>
				   		</div>
			   		</div>
                    ...
                    <div class="search-wrap">
                        <div class="container">
                            <ul class="nav nav-tabs">
                                <li class="active"><a data-toggle="tab" href="#flight"><i class="flaticon-plane lang" Key="fl1">Flight</a></i></li>
                                <li><a data-toggle="tab" href="#hotel"><i class="flaticon-resort lang " key="fl2"> Hotel</a></i></li>
                                <li><a data-toggle="tab" href="#car"><i class="flaticon-car lang " key="fl3">Car Rent</a></i></li>
                                <li><a data-toggle="tab" href="#cruises"><i class="flaticon-boat lang " key="fl4">Cruises</a></i></li>
                            </ul>
                        </div>
...
<div class="container">
	<h2 class="f2" style="font-family: routes;"><center>Popular Routes From and In INDIA.</center></h2>
    <div class="jumbotron" style="margin-top: 100px; padding: 0px 0px;">
        <div class="row">
            <div class="col-sm-6">
                ...
                <div class="col-sm-4">
                    <ul class="flight">
                       ...
                       <li class=""><a href=""><p style="font-family:flight; ">Delhi to Mumbai Flights</p></a></li><br>
                        <li class=""><a href="atm.html"><p style="font-family:flight; ">Ahmedabad to Mumbai Flights</p></a></li><br>
                        <li class=""><a href="#"><p style="font-family:flight; ">Delhi to Lahore Flights</p></a></li><br>
                    </ul>
                ...
                <div class="col-sm-4">
                    ...
                    <ul class="flight">
                        ...
                        <li class=""><a href="#"><p style="font-family:flight; ">London to Costa Rica Flights</p></a></li><br>
                        <li class=""><a href="#"><p style="font-family:flight; ">France to Croatia Flights</p></a></li><br>
                        <li class=""><a href="#"><p style="font-family:flight; ">Berlin to London Flights</p></a></li><br>
                    </ul>
                ...
                <div class="col-sm-4">
                    <ul class="flight">
                        ...
                        <li class=""><a href="#"><p style="font-family:flight; ">Banaras to Tokyo Flights</p></a></li><br>
                        <li class=""><a href="#"><p style="font-family:flight; ">Singapore to Mumbai Flights</p></a></li><br>
                        <li class=""><a href="#"><p style="font-family:flight; ">Delhi to Mumbai Flights</p></a></li><br>
                    </ul>
...
<div class="col-sm-6">
                <div class="col-sm-4">
                    <ul class="flight">
                       ...
                       <li class=""><a href="#"><p style="font-family:flight; ">Delhi to Jaipur Flights</p></a></li><br>
                        <li class=""><a href="#"><p style="font-family:flight; ">Pennsylvania to Sweden Flights</p></a></li><br>
                        <li class=""><a href="#"><p style="font-family:flight; ">Sweden to Zurich Flights</p></a></li><br>
                    </ul>
                ...
                <div class="col-sm-4">
                    ...
                    <ul class="flight">
                        ...
                        <li class=""><a href="#"><p style="font-family:flight; ">Stockholm to Mumbai Flights</p></a></li><br>
                        <li class=""><a href="#"><p style="font-family:flight; ">Delhi to Goa Flights</p></a></li><br>
                        <li class=""><a href="#"><p style="font-family:flight; ">Goa to Tokyo Flights</p></a></li><br>
                    </ul>
                ...
                <div class="col-sm-4">
                    <ul class="flight">
                        ...
                        <li class=""><a href="#"><p style="font-family:flight; ">Finland to Belgium Flights</p></a></li><br>
                        <li class=""><a href="#"><p style="font-family:flight; ">Belgium to Mumbai Flights</p></a></li><br>
                        <li class=""><a href="#"><p style="font-family:flight; ">Delhi to Vatican City Flights</p></a></li><br>
                    </ul>
...
<!-- end flights-->
		...
		<footer id="colorlib-footer" role="contentinfo" style="width: 100%;">
            <div class="container">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved <i class="icon-heart2" aria-hidden="true"></i> by <a href="#" target="_blank">BeyonSky</a>
</span> 
