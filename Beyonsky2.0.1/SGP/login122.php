...
.col-xs-2{
	...
	<div id="page">
		...
		<nav class="colorlib-nav" role="navigation">
                        ...
                        <div class="col-xs-10 text-right menu-1">
                            ...
                            <li class="has-dropdown">
                                    ...
                                    <ul class="dropdown" style="margin-left: -10px;">
                                        <li ><a href="Login.html"><button style="  background-color: transparent;
                                            background-repeat:no-repeat;
                                            border: none;
                                            font-size: 1.2em;
                                            font-color: white;
                                        ...
                                        <li ><a href="signup.html"><button style="  background-color: transparent;
                                                background-repeat:no-repeat;
                                                border: none;
                                                font-color: white;
                                                font-weight: 900;
            ...
            <aside id="colorlib-hero" style="height:900px;">
						<div class="flexslider"style="height:900px;">
				<ul class="slides"style="height:900px;">
			   	<li style="background-image: url(images/i.jpg);height:900px;">

			   		<div class="container-fluid">

			   		<div class="row">
				   	<div class="col-md-6 col-md-offset-3 col-sm-12 col-xs-12 slider-text">
                        <p class="lang" key="sgn" style="font-size: 100px; color: #fff; text-align:Center ;margin-top:80px ;margin-bottom: -250px;margin-left: -50px;">Sign In</p>
                            <br>
                <div class="container-login" style="margin-left: -125px;margin-top:250px;height:600px;">
