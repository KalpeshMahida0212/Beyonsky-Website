...
<script src="jquery-3.2.1.m.js"></script>
    ...
    <script type="text/javascript">
        ...
        arrLang['en']['cf3'] = 'Lastdasda Name';
        arrLang['en']['cf1'] = 'Get In Touch';
        arrLang['en']['cf2'] = 'First Name';
        arrLang['en']['cf3'] = 'Last Name';
        arrLang['en']['cf4'] = 'Email';
        arrLang['en']['cf5'] = 'Subject';
        arrLang['en']['cf6'] = 'Message';
        arrLang['en']['ctus'] = 'Contact Us';
        ...
        arrLang['hi']['ctus'] = 'हमसे संपर्क करें';
        ...
        arrLang['hi']['cf1'] = 'संपर्क में रहो';
        arrLang['hi']['cf2'] = 'पहला नाम';
        arrLang['hi']['cf3'] = 'उपनाम';
        arrLang['hi']['cf4'] = 'ईमेल';
        arrLang['hi']['cf5'] = 'विषय';
        arrLang['hi']['cf6'] = 'संदेश';
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-10 text-right menu-1">
                            <ul>
                                ...
                                <li><a class="lang" key="hm14" href="contacts.php"style="font-size:18px ;">Contact</a></li>
				...
				<div class="row">
						...
						<form action="#">
							<div class="row form-group">
								<div class="col-md-6 padding-bottom">
									...
									<label for="first_name"><font class="lang" key="cf2" style="font-size: 21px;">First Name</font></label>
									<input type="text" id="lname" class="form-control" placeholder="Your lastname">
								</div>
								<div class="col-md-6">
									<label for="last_name" class="lang" key="cf3"><font style="font-size: 21px;">Last Name</font></label>
									<input type="text" id="lname" class="form-control" placeholder="Your lastname">
								</div>
							</div>
							...
							<div class="form-group text-center">
								<input type="submit" value="Send Message" class="btn btn-primary" name="ok">
							</div>
					...
					<div class="col-md-10 col-md-offset-1 animate-box">
						...
						<div class="row contact-info-wrap">
							...
							<div class="col-md-3">
								<p><span><i class="icon-subject3"></i></span> <a href="#"> +91 7016 801 305</a></p>
							</div>
							<div class="col-md-3">
